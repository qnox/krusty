//! Shared source-input classification.

use std::path::Path;

/// A source language understood by the shared frontend.
...
impl SourceKind {
    /// Batch emission does not yet implement Kotlin script semantics.
...
/// Source text tagged before it enters shared frontend dispatch.
...
/// Extensions discoverable by source-aware adapters.
