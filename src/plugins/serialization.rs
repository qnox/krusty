...
fn custom_serializer_of(ctx: &PluginContext, ir: &IrFile, class_id: ClassId) -> Option<String> {
...
fn serializer_fq(class_fq: &str) -> String {
    crate::types::type_name_nested_child(type_name(class_fq), "$serializer").render()
}
