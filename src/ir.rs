...
pub struct IrClass {
    ...
    /// `$serializer` omits `typeParametersSerializers`. Empty on a source-declared class, whose
    /// members are described from their own declarations.
    ///
    ...
    pub published_generated_functions: Vec<FunId>,
