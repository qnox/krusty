...
//!
//! The coroutine transformation runs from `classfile::coroutine_transform`; the redundant-null-check
//! and redundant-cast passes, temporary elimination, the stack peephole, `goto` cleanup, jump
//! negation, dead-code elimination and slot compaction from `classfile::method_rewrite`.
