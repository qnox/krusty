...
// The declaration decode is carrier-independent and lives in the core. What stays here is the JVM
// carrier (`@Metadata`'s `d1`/`d2` string arrays) and the JVM's own reading of what was decoded.
...
/// The JVM class access flags a Kotlin `Class.flags` word describes.
///
...
pub fn builtin_class_access(flags: u64) -> u16 {
