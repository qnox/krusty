//! Unbound callable references whose receiver type and targets come from a dependency. Member
//! functions, member properties, and extension properties all use the existing function/property
//! reference runtime objects; only their selected targets come from classpath metadata.
