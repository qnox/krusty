...
#[path = "common_expectation_e2e.rs"]
mod common_expectation_e2e;
...
#[path = "klib_value_class_e2e.rs"]
mod klib_value_class_e2e;
#[path = "klib_visibility_e2e.rs"]
mod klib_visibility_e2e;
