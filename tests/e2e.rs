...
#[path = "anonymous_capture_discovery_e2e.rs"]
...
#[path = "backtick_keyword_identifier_e2e.rs"]
...
#[path = "classpath_overload_trailing_lambda_e2e.rs"]
mod classpath_overload_trailing_lambda_e2e;
...
#[path = "context_parameter_signature_order_e2e.rs"]
...
mod fq_generic_ctor_property_inference_e2e;
...
#[path = "generic_hof_vc_binding_e2e.rs"]
mod generic_hof_vc_binding_e2e;
...
mod lvt_parity_e2e;
#[path = "main_entry_point_conflict_e2e.rs"]
mod main_entry_point_conflict_e2e;
...
#[path = "nullable_primitive_parameter_name_e2e.rs"]
mod nullable_primitive_parameter_name_e2e;
...
#[path = "child_serializer_accessor_line_e2e.rs"]
mod child_serializer_accessor_line_e2e;
...
#[path = "value_class_type_parameter_erasure_e2e.rs"]
mod value_class_type_parameter_erasure_e2e;
