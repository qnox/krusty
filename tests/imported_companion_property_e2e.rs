//! Explicit imports of source companion properties resolve through the same static-property symbol
//! used by qualified reads, for both shared frontend analysis and JVM lowering.
...
val fragment: String = "wrong"
"#;
    const USE: &str = r#"
package consumer

import source.Outer.Holder.Companion.fragment

fun value(suffix: String = "K"): String = fragment + suffix
